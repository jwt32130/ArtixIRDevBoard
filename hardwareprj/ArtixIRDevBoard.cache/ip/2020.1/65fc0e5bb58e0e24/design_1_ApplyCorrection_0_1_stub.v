...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_ApplyCorrection_0_1_stub.v
...
/* synthesis syn_black_box black_box_pad_pin="s_axi_CRTL_BUS_AWADDR[4:0],s_axi_CRTL_BUS_AWVALID,s_axi_CRTL_BUS_AWREADY,s_axi_CRTL_BUS_WDATA[31:0],s_axi_CRTL_BUS_WSTRB[3:0],s_axi_CRTL_BUS_WVALID,s_axi_CRTL_BUS_WREADY,s_axi_CRTL_BUS_BRESP[1:0],s_axi_CRTL_BUS_BVALID,s_axi_CRTL_BUS_BREADY,s_axi_CRTL_BUS_ARADDR[4:0],s_axi_CRTL_BUS_ARVALID,s_axi_CRTL_BUS_ARREADY,s_axi_CRTL_BUS_RDATA[31:0],s_axi_CRTL_BUS_RRESP[1:0],s_axi_CRTL_BUS_RVALID,s_axi_CRTL_BUS_RREADY,ap_clk,ap_rst_n,interrupt,Frame_TVALID,Frame_TREADY,Frame_TDATA[31:0],Frame_TDEST[5:0],Frame_TKEEP[3:0],Frame_TSTRB[3:0],Frame_TUSER[1:0],Frame_TLAST[0:0],Frame_TID[4:0],GainOffset_TVALID,GainOffset_TREADY,GainOffset_TDATA[63:0],GainOffset_TDEST[5:0],GainOffset_TKEEP[7:0],GainOffset_TSTRB[7:0],GainOffset_TUSER[1:0],GainOffset_TLAST[0:0],GainOffset_TID[4:0],Output_r_TVALID,Output_r_TREADY,Output_r_TDATA[31:0],Output_r_TDEST[5:0],Output_r_TKEEP[3:0],Output_r_TSTRB[3:0],Output_r_TUSER[1:0],Output_r_TLAST[0:0],Output_r_TID[4:0]" */;
