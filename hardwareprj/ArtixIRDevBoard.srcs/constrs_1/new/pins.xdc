...
create_generated_clock -name design_1_i/ClockManager_0/U0/OutBuffer_reg/Q -source [get_pins design_1_i/Clk100] -divide_by 4 [get_pins design_1_i/ClockManager_0/U0/OutBuffer_reg/Q]

create_clock -period 10.000 -name ClockPort100 -waveform {0.000 5.000} [get_ports -filter { NAME =~  "*Clk100*" && DIRECTION == "IN" }]
